...
public class Login extends javax.swing.JFrame {
    ...
    public boolean validateLogin(){
        ...
        if (name.equals("")){
            JOptionPane.showMessageDialog(this,"Ingrese usuario, por favor.");
            return false;
        }
        if (pwd.equals("")){
            JOptionPane.showMessageDialog(this,"Ingrese contraseña, por favor.");
            return false;
        }
    ...
    public void login(){
        ...
        try {
            ...
            ResultSet rs = s.executeQuery("SELECT *FROM users WHERE user_name = '"+name+"' AND user_pass = '"+pwd+"'");
    ...
    private void initComponents() {
        ...
        jLabel11.setText("A continuación, ingrese usuario");
